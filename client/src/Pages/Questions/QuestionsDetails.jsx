            ...
            .map((question) => (
              <div key={question._id}>
                ...
                <section className=" question-details-container">
                  ...
                  <div className=" question-details-container-2">
                    ...
                    <div style={{ width: "100" }}>
                      ...
                      <div className="question-details-tgs">
                ...
                {question.noOfAnswers !== 0 && (
                  <section>
                    <h3>
                      <question className=''>{question.noOfAnswers} answer </question>
                    </h3>
                    <DisplayAnswer key={question.id} question=
                    {question}  handleShare={handleShare}/>
                  </section>
                )
                }
